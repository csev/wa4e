...
the actual install.
Make sure you are doing this on an administrator account.  You may need to 
enter the password for the administrator account during installation.
</p>
<p>
Then Navigate into <b>C:\MAMP</b> to start the control panel.  
...
<pre>
C:\MAMP\bin/php/php7.1.0/conf/php.ini
</pre>
